---
description: Um sinalizador booleano opcional que controla como o serviço de ID do visitante carrega o iFrame de sincronização de ID.
...
**Sintaxe:** ` `idSyncAttachIframeOnWindowLoad= true false&grave;&grave; (o padrão é `false`.)
