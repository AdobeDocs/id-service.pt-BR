---
description: Configure o Serviço de ID de visitante ao passar essas propriedades para o método estático Visitor.getInstance.
keywords: ID da organização IMS;Serviço de ID do visitante
title: Configurações
...
Configure o Serviço de ID de visitante ao passar essas propriedades para o método estático Visitor.getInstance.
