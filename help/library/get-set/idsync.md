---
description: As funções idSyncByURL e idSyncByDataSource do Serviço de ID de visitante permitem implementar manualmente uma sincronização de ID no iFrame de publicação de destino. Eles estão disponíveis na VisitorAPI.js versão 1.10 ou superior.
...
As funções idSyncByURL e idSyncByDataSource do Serviço de ID de visitante permitem implementar manualmente uma sincronização de ID no iFrame de publicação de destino. Eles estão disponíveis em `VisitorAPI.js` versões 1.10 ou superiores.
