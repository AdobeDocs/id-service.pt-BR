---
description: getCustomerIDs retorna quaisquer IDs do cliente definidas pelo Serviço de ID do visitante.
...
getCustomerIDs retorna quaisquer IDs do cliente definidas pelo Serviço de ID do visitante.
