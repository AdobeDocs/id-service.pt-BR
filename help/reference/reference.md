...
* [Visão geral da referência do Analytics](analytics-reference/analytics-reference.md)
...
* [Obter IDs de região e usuário do cookie AMCV ou do serviço de ID](regions.md)
