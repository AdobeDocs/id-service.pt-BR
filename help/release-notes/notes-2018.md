...
<table id="table_201417BD540E4EE69911AABE9BF77509"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Maior segurança para cookies AMCV </p> </td> 
...
<table id="table_6546F5C74E4742E4B5E9793BCEAB66FA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Correção de um problema ao validar "setCustomerIDs" quando os dados contêm um "código" ou um "id" de integração que não é um número nem uma sequência de caracteres não vazia. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> O ECID JS está disponível em acordos de recompra Git público </td> 
   <td colname="col2"> O ECID JS agora está disponível no Public Git Repo para todos os clientes do Experience Cloud em https://github.com/Adobe-Marketing-Cloud/id-service/releases. </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_512039AFC4D34038B8F116B71EEEE7F6"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Corrigimos um erro em que o cookie do Visitante temporário estava configurando um cookie no domínio do cookie "padrão" em vez de configurá-lo no domínio fornecido na configuração (initConfig). </p> </td> 
  </tr> 
 </tbody> 
</table>
