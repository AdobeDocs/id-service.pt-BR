---
description: Estas instruções são para clientes do Analytics e do Audience Manager que desejam usar o Serviço de ID de visitante e não usam tags do. No entanto, recomendamos que você use tags para implementar o Serviço de ID de visitante. As tags simplificam o fluxo de trabalho de implementação e automaticamente garante o posicionamento e sequenciamento corretos do código.
keywords: Serviço de ID de visitante
title: Implementar o serviço de ID de visitante da Adobe para o Analytics e o Audience Manager
...
## Etapa 9: testar e implantar o código do Serviço de ID de visitante {#section-f857542bfc70496dbb9f318d6b3ae110}

É possível testar e implantar da seguinte maneira.

**Testar e verificar**

Para testar a implementação do Serviço de ID de visitante, verifique:

* [Cookie AMCV](../introduction/cookies.md) no domínio em que as páginas estão hospedadas.
* O valor da MID na solicitação de imagem do Analytics com o [Adobe Debugger](https://experienceleague.adobe.com/docs/analytics/implementation/validate/debugger.html?lang=pt-BR).
* Consulte também [Testar e verificar o Serviço de ID de Visitante](../implementation-guides/test-verify.md).

Para verificar o encaminhamento do lado do servidor, consulte [Como verificar a implementação de encaminhamento do lado do servidor](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/server-side-forwarding/ssf-verify.html?lang=pt-BR).
