...
# Configuração do Opt-in com a Experience Platform Launch {#configuring-opt-in-with-launch}
...
Para obter mais informações de referência, leia o [Visão geral da extensão do Adobe Experience Cloud Identity Service](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/client/id-service/overview.html?lang=pt-BR).
