...
Além das etapas descritas, os clientes que usam o [!DNL Analytics] e o [!DNL Audience Manager] devem migrar para o encaminhamento do lado do servidor. O encaminhamento pelo lado do servidor permite remover o DIL (código de coleta de dados do Audience Manager) e substituí-lo pelo [Módulo de gerenciamento de público-alvo](https://marketing.adobe.com/resources/help/en_US/aam/c_profiles_audiences.html). Consulte a [documentação de encaminhamento do lado do servidor](https://marketing.adobe.com/resources/help/pt_BR/reference/ssf.html) para obter mais informações.
...
>[!IMPORTANT]
>
>Nesse momento, é necessário remover o código [!DNL Audience Manager] DIL do e substituí-lo pelo Módulo de gerenciamento de público-alvo. Consulte [Implementar o encaminhamento do lado do servidor](https://marketing.adobe.com/resources/help/pt_BR/reference/ssf.html) para obter instruções.
...
Consulte também [Referência da coluna de dados da sequência de cliques](https://marketing.adobe.com/resources/help/pt_BR/sc/clickstream/datafeeds_reference.html).
...
>[!TIP]
>
>É possível usar o [Adobe Debugger](https://marketing.adobe.com/resources/help/pt_BR/sc/implement/?f=debugger.html) ou o [Charles HTTP proxy](https://www.charlesproxy.com/) para verificar essas IDs específicas da solução. Entretanto, você pode usar qualquer ferramenta ou depurador adequado para suas necessidades.
...
Para testar o encaminhamento do lado do servidor, consulte:
...
* [Como determinar se a sua conta não está pronta para receber os dados encaminhados](https://marketing.adobe.com/resources/help/en_US/aam/ssf-fail.html)
