...
Use o Adobe Launch para implementar o Opt-in e o plugin IAB no seu site. Leia a [documentação da extensão de Opt-in ECID](https://marketing-beta.adobe.com/resources/help/launch/ecid-optin/) para saber como configurar a extensão do Launch.
